...
3. **通信設定**  
   ...
   - 現在 (2025-11-12) の Pi IP: **自宅 `192.168.0.12` / 研究室 `192.168.11.11`**。いずれかを変更した場合は README と本ファイルの両方を更新すること。
4. **安全運用・ログ**  
...
- 2025-11-12: 自宅=192.168.0.12、研究室=192.168.11.11 の静的 IP で運用する手順を追記。
